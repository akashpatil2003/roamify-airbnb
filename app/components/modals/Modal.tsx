        ...
        <>
            ...
            >
                ...
                >
                    ...
                    >
                        <div
                            className="translate h-full lg:h-auto md:h-auto border-0 rounded-lg shadow-lf relative flex flex-col w-full bg-white outline-none focus:outline-none"
                        >
                            <div
                                className="flex items-center p-6 rounded-t justify-center relative border-b-[1px] border-gray-200"
                            >
                                <button
                                    onClick={handleClose}
